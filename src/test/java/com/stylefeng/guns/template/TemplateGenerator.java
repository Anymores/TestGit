...
public class TemplateGenerator {
    ...
    public static void main(String[] args) throws IOException {
        ...
        contextConfig.setBizChName("文件上传");
        contextConfig.setBizEnName("Files");
        contextConfig.setModuleName("Files");
        contextConfig.setProjectPath("C:\\Users\\史鹏宇\\Desktop\\新建文件夹");
