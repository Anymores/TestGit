...
public class MyBatisPlusGenerator {
    ...
    public static void main(String[] args) {
        ...
        gc.setOutputDir("C:\\Users\\史鹏宇\\Desktop\\新建文件夹");//这里写你自己的java目录
        ...
        dsc.setUsername("roots");
        dsc.setPassword("xuhong521");
        dsc.setUrl("jdbc:mysql://192.168.0.101:3306/guns?characterEncoding=utf8");
        ...
        strategy.setInclude(new String[]{"file_upload_spy"});
